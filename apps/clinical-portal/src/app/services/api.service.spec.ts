...
describe('ApiService', () => {
  ...
  it('supports POST, PUT, PATCH, and DELETE requests', () => {
    ...
    httpMock.expectOne('api/post').flush({ ok: true }, 30000);
    httpMock.expectOne('api/put').flush({ ok: true }, 30000);
    httpMock.expectOne('api/patch').flush({ ok: true }, 30000);
    httpMock.expectOne('api/delete').flush({ ok: true }, 30000);
  }, 30000);
