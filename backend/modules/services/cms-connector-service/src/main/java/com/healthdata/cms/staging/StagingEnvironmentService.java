...
public class StagingEnvironmentService {
    ...
    public StagingValidationReport validateStagingEnvironment() {
        var reportBuilder = StagingValidationReport.builder()
            .timestamp(LocalDateTime.now(ZoneId.of("UTC")));
    ...
    public GoNoGoDecision evaluateGoNoGoCriteria(StagingValidationReport report,
        ...
        var decisionBuilder = GoNoGoDecision.builder()
            .timestamp(LocalDateTime.now(ZoneId.of("UTC")));
        ...
        criteria.add(GoNoGoDecision.GoNoCriterion.builder()
            ...
            .result(metrics.isE2eTestsPassed())
            .threshold(true)
            .status(metrics.isE2eTestsPassed() ? "GO" : "NO-GO")
            .build());

        criteria.add(GoNoGoDecision.GoNoCriterion.builder()
            .category("Functional")
            .criterion("Multi-tenant isolation verified")
            .result(metrics.isMultiTenantIsolationVerified())
            .threshold(true)
            .status(metrics.isMultiTenantIsolationVerified() ? "GO" : "NO-GO")
            .build());
        ...
        criteria.add(GoNoGoDecision.GoNoCriterion.builder()
            ...
            .result(metrics.isMonitoringConfigured())
            .threshold(true)
            .status(metrics.isMonitoringConfigured() ? "GO" : "NO-GO")
            .build());

        criteria.add(GoNoGoDecision.GoNoCriterion.builder()
            .category("Operational")
            .criterion("All runbooks and playbooks documented")
            .result(metrics.isRunbooksDocumented())
            .threshold(true)
            .status(metrics.isRunbooksDocumented() ? "GO" : "NO-GO")
            .build());
