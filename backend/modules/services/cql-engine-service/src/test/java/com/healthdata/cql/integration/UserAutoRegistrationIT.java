...
/**
 * Integration test for UserAutoRegistrationFilter in CQL Engine Service.
 */
@SpringBootTest
@ActiveProfiles("test")
@Import(TestRedisConfiguration.class)
@Transactional
@DisplayName("UserAutoRegistrationFilter — CQL Engine Service")
class UserAutoRegistrationIT extends CqlTestcontainersBase {
