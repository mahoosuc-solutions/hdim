package com.healthdata.cqlengine.validation;
...
/**
 * Entity-migration validation for cql-engine-service.
 *
 ...
 *
 * Note: This test is in a separate package (com.healthdata.cqlengine.validation) to
 * avoid Spring Boot auto-scanning for @SpringBootConfiguration in com.healthdata.cql.
 */
@DataJpaTest(
    properties = {
...
class EntityMigrationValidationTest {
    ...
    @EntityScan(basePackages = "com.healthdata.cql.entity")
    static class TestConfig {
    }

    @Container
    static PostgreSQLContainer<?> postgres = new PostgreSQLContainer<>("postgres:16-alpine")
            .withDatabaseName("cql_test")
    ...
    void validateAllEntitiesMatchDatabaseSchema() {
        ...
        assertTrue(report.isValid(),
                "Entity-migration validation failed for cql-engine-service.\n" +
    ...
    void validateCriticalCqlEntities() {
        ...
        assertTrue(report.isValid(),
                "Critical entity-migration validation failed for cql-engine-service.\n" +
                report.getDetailedMessage());
    }
}
