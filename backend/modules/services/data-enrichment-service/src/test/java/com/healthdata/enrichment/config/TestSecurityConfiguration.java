 ...
 * - SecurityFilterChain is already configured in EnrichmentSecurityConfig for test profile
 *
 * Usage:
 ...
 * - EnrichmentSecurityConfig already provides testSecurityFilterChain that permits all requests
 *
 * Example Test Setup:
 * <pre>
 * @SpringBootTest(classes = {
 *     DataEnrichmentServiceApplication.class,
