...
/**
 * ECR Service Security Configuration
 *
...
public class EcrSecurityConfig {
     ...
     * Protected endpoints: All ECR API endpoints require gateway authentication
     */
    @Bean
    @Profile("!test")
    @Order(2)
    public SecurityFilterChain filterChain(
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // All ECR API endpoints require authentication (HIPAA §164.312(d))
