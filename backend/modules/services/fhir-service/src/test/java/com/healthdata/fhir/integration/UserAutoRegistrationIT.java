...
/**
 * Integration test for UserAutoRegistrationFilter in FHIR Service.
 */
@Transactional
@DisplayName("UserAutoRegistrationFilter — FHIR Service")
class UserAutoRegistrationIT extends AbstractFhirIntegrationTest {
