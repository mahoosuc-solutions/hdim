...
/**
 * HCC Service Security Configuration
 *
...
public class HccSecurityConfig {
     ...
     * Protected endpoints: All HCC API endpoints require gateway authentication
     */
    @Bean
    @Profile("!test")
    @Order(2)
    public SecurityFilterChain filterChain(
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // All HCC API endpoints require authentication (HIPAA §164.312(d))
