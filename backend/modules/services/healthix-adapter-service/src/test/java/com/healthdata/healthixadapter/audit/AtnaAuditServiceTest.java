...
class AtnaAuditServiceTest {
    ...
    private final AtnaAuditService auditService = new AtnaAuditService("healthix-adapter-service", "FULL");
    ...
    void buildAuditEvent_includesAllRequiredFields() {
        ...
        assertThat(event.getSourceSystem()).isEqualTo("healthix-adapter-service");
        ...
        assertThat(event.getPhiLevel()).isEqualTo("FULL");
    }
