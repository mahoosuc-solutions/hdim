...
class ApiKeyAuthFilterTest {
    ...
    void wrongApiKey_returns401() throws Exception {
        ...
        request.setRequestURI("/healthix-adapter/api/v1/external/healthix/hl7/adt");
    ...
    void actuatorEndpoint_skipsAuth() throws Exception {
        request.setRequestURI("/healthix-adapter/actuator/health");
    ...
    void statusEndpoint_skipsAuth() throws Exception {
        request.setRequestURI("/healthix-adapter/api/v1/external/healthix/status");
    ...
    @Test
    void requestWithTenantHeader_passesThrough() throws Exception {
        request.addHeader("X-API-Key", "test-api-key-12345");
