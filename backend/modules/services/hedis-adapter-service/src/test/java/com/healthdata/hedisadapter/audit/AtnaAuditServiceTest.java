...
class AtnaAuditServiceTest {
    ...
    private final AtnaAuditService auditService = new AtnaAuditService("hedis-adapter-service", "LIMITED");
    ...
    void buildAuditEvent_includesAllRequiredFields() {
        ...
        assertThat(event.getSourceSystem()).isEqualTo("hedis-adapter-service");
        ...
        assertThat(event.getPhiLevel()).isEqualTo("LIMITED");
    }
