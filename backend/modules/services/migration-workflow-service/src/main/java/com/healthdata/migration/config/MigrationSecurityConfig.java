...
public class MigrationSecurityConfig {
     ...
     *
     * Public endpoints: Health checks, API documentation, WebSocket streams
     * Protected endpoints: All migration API endpoints require gateway authentication
     */
    @Bean
    @Profile("!test")
    @Order(2)
    public SecurityFilterChain securityFilterChain(
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // All migration API endpoints require authentication (HIPAA §164.312(d))
