package com.healthdata.notificationvalidation;
...
/**
 * Entity-migration validation for notification-service.
 *
 ...
 *
 * This test is in a separate package (com.healthdata.notificationvalidation) to
 * avoid Spring Boot auto-scanning for @SpringBootConfiguration in com.healthdata.notification.
 */
@DataJpaTest(
    properties = {
...
class EntityMigrationValidationTest {
    ...
    @EntityScan(basePackages = "com.healthdata.notification.domain.model")
    ...
    void validateAllEntitiesMatchDatabaseSchema() {
        ...
        assertTrue(report.isValid(),
                "Entity-migration validation failed for notification-service.\n" +
    ...
    void validateCriticalNotificationEntities() {
        ...
        Set<EntityType<?>> criticalEntities = entities.stream()
                .filter(e -> {
                    ...
                    return name.equals("Notification") ||
        ...
        assertTrue(report.isValid(),
                "Critical entity-migration validation failed for notification-service.\n" +
                report.getDetailedMessage());
    }
}
