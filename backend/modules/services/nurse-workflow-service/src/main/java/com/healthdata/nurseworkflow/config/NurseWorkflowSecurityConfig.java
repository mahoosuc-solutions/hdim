package com.healthdata.nurseworkflow.config;
...
/**
 * Nurse Workflow Service Security Configuration
 *
 ...
 *
 * HIPAA Compliance:
 * - All nurse endpoints require authentication (HIPAA §164.312(d))
 ...
 */
@Configuration
public class NurseWorkflowSecurityConfig {
     ...
     * Protected endpoints: All nurse workflow operations require gateway authentication
     *
     * HIPAA Compliance (HIPAA §164.312(d)):
     * - All endpoints require authentication except health/info
     * - Audit logging provided by @Audited annotations
     * - Tenant isolation enforced by TrustedTenantAccessFilter
     */
    @Bean
    @Profile("!test & !demo")
    @Order(2)
    public SecurityFilterChain securityFilterChain(
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // All nurse workflow endpoints require authentication (HIPAA §164.312(d))
     ...
     * Permits all requests while keeping authentication for audit logging.
     */
    @Bean
    @Profile("demo")
    @Order(2)
