...
class CQRSEventFlowIntegrationTest {
    ...
    void shouldEnforceMultiTenantIsolation() throws Exception {
        ...
        assertThat(response1).contains("patient-tenant1");
        assertThat(response1).doesNotContain("patient-tenant2");

        assertThat(response2).contains("patient-tenant2");
        assertThat(response2).doesNotContain("patient-tenant1");
    }
    ...
    void shouldFilterPatientsByGender() throws Exception {
        ...
        String responseBody = result.getResponse().getContentAsString();
        assertThat(responseBody)
            .contains("patient-male")
            .doesNotContain("patient-female");
    }
