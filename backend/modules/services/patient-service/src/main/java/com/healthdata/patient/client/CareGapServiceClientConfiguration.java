...
/**
 * Configuration for Care Gap Service Feign Client
 *
 * Configures logging and headers for communication with the Care Gap Service.
 *
 ...
 */
public class CareGapServiceClientConfiguration {

    /**
     * Configure Feign logging level to FULL for debugging
     */
    @Bean
    Logger.Level careGapServiceLoggerLevel() {
     ...
     */
    @Bean
    public RequestInterceptor careGapContentTypeInterceptor() {
