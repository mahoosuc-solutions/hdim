package com.healthdata.payervalidation;
...
/**
 * Entity-migration validation for payer-workflows-service.
 *
 ...
 *
 * Note: payer-workflows-service is a workflow/client service and does not define
 * its own JPA entities. This test validates that no unintended entities exist.
 */
@DataJpaTest(
    properties = {
...
class EntityMigrationValidationTest {
    ...
    void validateAllEntitiesMatchDatabaseSchema() {
        ...
        assertTrue(report.isValid(),
                "Entity-migration validation failed for payer-workflows-service.\n" +
