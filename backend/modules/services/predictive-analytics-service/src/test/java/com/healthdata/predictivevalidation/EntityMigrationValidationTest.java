package com.healthdata.predictivevalidation;
...
/**
 * Entity-migration validation for predictive-analytics-service.
 *
 ...
 *
 * Note: predictive-analytics-service is primarily a computational service and
 * does not define its own JPA entities. This test validates that no unintended entities exist.
 */
@DataJpaTest(
    properties = {
...
class EntityMigrationValidationTest {
    ...
    @EntityScan(basePackages = "com.healthdata.predictive.persistence")
    ...
    void validateAllEntitiesMatchDatabaseSchema() {
        ...
        // predictive-analytics-service does not define its own JPA entities
        if (entities.isEmpty()) {
            return;
        }
        ...
        assertTrue(report.isValid(),
                "Entity-migration validation failed for predictive-analytics-service.\n" +
