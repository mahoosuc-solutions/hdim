...
public class PriorAuthSecurityConfig {
     ...
     * Protected endpoints: All Prior Auth API endpoints require gateway authentication
     */
    @Bean
    @Profile("!test")
    @Order(2)
    public SecurityFilterChain securityFilterChain(
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // All Prior Auth API endpoints require authentication (HIPAA §164.312(d))
