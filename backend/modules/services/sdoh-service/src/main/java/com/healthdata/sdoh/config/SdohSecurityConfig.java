...
/**
 * Security configuration for SDOH Service
 *
...
public class SdohSecurityConfig {
     ...
     * Protected endpoints: All SDOH API endpoints require gateway authentication
     */
    @Bean
    @Profile("!test")
    @Order(2)
    public SecurityFilterChain filterChain(
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // All SDOH API endpoints require authentication (HIPAA §164.312(d))
