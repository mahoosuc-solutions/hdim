...
public final class AuthHeaderConstants {
     ...
     */
    public static final String HEADER_CLIENT_IP = "X-Auth-Client-IP";

    /**
     * Header containing user agent string (for audit logging).
     * Example: X-Auth-User-Agent: Mozilla/5.0...
     */
    public static final String HEADER_USER_AGENT = "X-Auth-User-Agent";
