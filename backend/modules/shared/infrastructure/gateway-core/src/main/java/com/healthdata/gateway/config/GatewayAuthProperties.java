...
public class GatewayAuthProperties {
    ...
    void applyDemoDefaults() {
        if (demoUser == null) {
            demoUser = new DemoUserConfig();
            return;
        }
        List<String> tenantIds = demoUser.getTenantIds();
        if (tenantIds == null || tenantIds.isEmpty()) {
            demoUser.setTenantIds(List.of("demo-tenant"));
        }
    }
    ...
    public static class DemoUserConfig {
         ...
         */
        private List<String> tenantIds = List.of("demo-tenant", "acme-health");
