# HDIM Visual Asset Prompts V2.0 - Healthcare IT Implementation-Informed

## Research Foundation

This document replaces generic healthcare imagery with prompts informed by:
...
- Healthcare persona workflows and pain points
- Visual examples from actual healthcare IT implementations

---

## Brand Guidelines (Unchanged)
...
## 1. Hero Images - Real Healthcare Operations Context

### Main Hero - Desktop (1920x1080)
```
Create a professional healthcare technology hero image showing the REAL daily experience of care coordination.
...
RIGHT SIDE (40%): A warm, semi-transparent overlay showing the RESULT - a grandmother (Maria archetype, 67, Latina) healthy and playing with grandchildren in a garden setting.
...
- "56 HEDIS Measures" visible as a data point
- "5 min cache TTL" compliance indicator (small badge)
...
- Brand colors prominent in dashboard elements
```

### Hero - Care Manager Workflow (1920x1080)
```
Create a realistic healthcare IT workflow hero image showing BEFORE vs AFTER.

SPLIT SCREEN COMPOSITION:

LEFT HALF - "WITHOUT HDIM" (desaturated, grayer tones):
A stressed care manager surrounded by chaos:
- Multiple sticky notes on monitor edges
- 10+ browser tabs visible (representing system whack-a-mole)
...
RIGHT HALF - "WITH HDIM" (bright, brand colors):
...
CENTER DIVIDER: Subtle HDIM logo as the transformation point
...
### Hero - Population Health Command Center (1920x1080)
```
Create a modern healthcare operations center visualization showing population health management at scale.
...
## 2. Care Manager Persona Visuals

### Care Manager Sarah - The Daily Reality (800x1000)
```
Create an authentic portrait of a care manager in their actual work environment.
...
- Coffee mug with healthcare-related humor ("I'm a care manager, not a miracle worker")
...
PURPOSE: This image represents who HDIM is built FOR - the frontline care coordinator who deserves better tools.
```

### Care Manager at Point of Success (800x1000)
```
Create a portrait showing the MOMENT of impact - a care manager on a call that matters.
...
MOOD: This is the Mr. Delgado moment - the call that saves a life.
...
## 3. Patient Story Portraits - Updated with Clinical Context

### Maria - Diabetes Management Success (800x1000)
```
Create a warm, genuine portrait of Maria - a diabetes patient whose care gaps were closed.
...
### James - Depression Recovery, Back to Life (800x1000)
```
Create a hopeful portrait of James - a patient who recovered from depression through early screening.
...
### Eleanor - The Colonoscopy She Almost Didn't Get (800x1000)
```
Create a powerful portrait of Eleanor - a colorectal cancer survivor caught early through screening.

SUBJECT: Eleanor, 68, African American woman. She exudes strength and gratitude. Her silver locs are styled elegantly. She wears a deep blue blouse (brand color) with a meaningful piece of jewelry.
...
INCLUDE SUBTLE TEXT OVERLAY OPTION:
"They found it early. That changed everything."
...
## 4. Technical Dashboard Visualizations

### Care Gap Dashboard - Realistic UI (1440x900)
```
Create a realistic, modern healthcare quality dashboard that HDIM actually delivers.
...
- "FHIR R4 Connected" status indicator
- "CQL Engine: Online" status
- Data freshness timestamps on each widget
- 5-minute cache indicator (HIPAA compliance)

DESIGN REQUIREMENTS:
- Clean, modern SaaS aesthetic (Stripe/Linear design influence)
- White/light gray backgrounds
- Brand blue for primary elements
- Brand teal for positive trends/highlights
...
### Mobile Dashboard View (375x812)
```
Create a mobile-responsive version of the care gap dashboard.

SCREEN STRUCTURE:

TOP:
- Hamburger menu (left)
- "HDIM" wordmark (center)
...
## 5. Integration Architecture Visuals

### Healthcare IT Ecosystem Integration (1400x800)
```
Create a modern architecture diagram showing how HDIM connects to real healthcare systems.

LAYOUT: Hub-and-spoke with HDIM at center

CENTER HUB:
HDIM platform hexagon containing:
...
### The 5-Minute HIPAA Story (1920x1080)
```
Create a powerful visual explaining the 5-minute PHI cache TTL commitment.
...
## 6. Compliance and Trust Badges - Updated

### FHIR R4 Certification Badge (200x200)
```
Create a modern compliance badge for FHIR R4 certification.
...
- Brand blue primary, white accents
- Clean, minimal, professional

AVOID: Cluttered design, excessive text, dated certificate aesthetic
```

### CQL Engine Badge (200x200)
```
Create a badge representing CQL (Clinical Quality Language) capability.
...
- Brand colors with teal accent

MEANING: This badge signals "we execute the official measure logic, not our interpretation"
```

### HIPAA 5-Minute Cache Badge (200x200)
```
Create a badge highlighting the 5-minute PHI cache commitment.
...
- Brand blue with security/trust feel

MEANING: Differentiator showing stricter-than-required data handling
```

### Star Ratings Improvement Badge (200x200)
```
Create a badge showing Star Rating improvement capability.
...
## 7. Video Thumbnail Templates

### Care Manager Success Story (1920x1080)
```
Create a video thumbnail showing a care manager's transformation.
...
### Patient Story Thumbnail (1920x1080)
```
Create a video thumbnail for Eleanor's colorectal screening story.
...
### LinkedIn Thought Leadership (1200x627)
```
Create a LinkedIn post template for healthcare IT thought leadership.

LAYOUT:
- Left 60%: Space for headline text
- Right 40%: Relevant imagery (dashboard, person, or icon)
- Bottom: HDIM logo and CTA
...
### Twitter/X Statistics Card (1200x675)
```
Create a Twitter card template for sharing statistics.
...
COLOR: Brand blue background, white text, teal accent for statistic
```

---

## Asset Generation Priority (Updated)

### Tier 1 - Immediate (Week 1)
1. Main Hero Desktop - Care manager + human outcome
2. Care Gap Dashboard (realistic UI)
3. Sarah Portrait (care manager)
4. Eleanor Portrait (cancer survivor)
5. FHIR R4 Badge
6. CQL Badge
...
11. HIPAA 5-Minute Badge
12. Mobile Dashboard

### Tier 3 - Supporting (Week 3-4)
13. Population Health Command Center
14. Video thumbnails
15. Social media templates
16. Star Ratings Badge
17. Additional compliance badges
...
- [ ] Brand colors accurate (#0066CC primary, #00A5B5 accent)
- [ ] NO text/spelling errors in any UI elements
- [ ] Dashboard data is realistic and consistent
- [ ] Technical accuracy verified (56 measures, 29 services, 5-min cache)
- [ ] Human subjects have warm, authentic expressions (not stock photo feel)
- [ ] Healthcare IT context is accurate (Epic, Cerner, FHIR, CQL references)
...
*Based on: Healthcare IT Integration Research, CMS Guidelines Research, Persona Analysis*
