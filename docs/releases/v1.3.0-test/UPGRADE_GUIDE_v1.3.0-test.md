# HDIM Platform Upgrade Guide - v1.3.0-test

**From Version:** v1.2.0
**To Version:** v1.3.0-test
...
git pull origin v1.3.0-test
```

**Verification:**
```bash
git log -1  # Should show v1.3.0-test tag
```
...
**Verification:**
```bash
docker images | grep v1.3.0-test
```
