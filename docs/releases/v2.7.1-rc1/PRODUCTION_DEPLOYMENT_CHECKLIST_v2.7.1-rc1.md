# HDIM Platform Production Deployment Checklist - v2.7.1-rc1

**Target Deployment Date:** 2026-02-15
...
- [ ] Review [UPGRADE_GUIDE_v2.7.1-rc1.md](./UPGRADE_GUIDE_v2.7.1-rc1.md)
- [ ] Review [KNOWN_ISSUES_v2.7.1-rc1.md](./KNOWN_ISSUES_v2.7.1-rc1.md)
- [ ] Review [VERSION_MATRIX_v2.7.1-rc1.md](./VERSION_MATRIX_v2.7.1-rc1.md)
- [ ] Review [INTELLIGENCE_ROLLOUT_RUNBOOK_v2.7.1-rc1.md](./INTELLIGENCE_ROLLOUT_RUNBOOK_v2.7.1-rc1.md)
...
./scripts/production-backup.sh v2.7.1-rc1

# Verify backups
ls -lh /backups/production/v2.7.1-rc1/
```
...
- [ ] Migration count matches expected: 830
...
```bash
# Pull latest images
docker pull hdim/gateway-service:v2.7.1-rc1
docker pull hdim/patient-service:v2.7.1-rc1
# ... (all 34 services)
