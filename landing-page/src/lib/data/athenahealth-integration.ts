...
└─────────────────────────────────────────────────────────────────┘`,
    ...
    },
    {
      ...
      items: [
        ...
        'Deploy HDIM with the athena profile — Run the HDIM deployment with the athena-optimized configuration: ./hdim-installer.sh --profile athena (Docker) or set HDIM_PROFILE=athena in your .env file. This pre-configures OAuth2 token refresh intervals, athena API rate limit handling (5 req/sec per practice), and ambulatory-specific CQL measure libraries.',
