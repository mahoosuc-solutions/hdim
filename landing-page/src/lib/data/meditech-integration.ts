...
└───────────────────────────────────────────────────────────────────┘`,
    ...
    },
    {
      ...
      items: [
        ...
        'Deploy HDIM using the community-hospital profile — Run the HDIM installer with the community profile for right-sized configuration: ./hdim-installer.sh --profile community. This pre-configures connection pooling, memory sizing, and Kafka partitioning appropriate for community hospital volumes (5,000–150,000 attributed patients) without requiring enterprise-grade infrastructure.',
